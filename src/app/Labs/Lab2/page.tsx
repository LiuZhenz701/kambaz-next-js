...
import BootstarpGrids from "./BootstrapGrids";
...
export default function Lab2() {
  return (
    <Container>
      ...
      {/* use style field to create style */}
      ...
      {/* use class selector and css file to style different kindfs of elements*/}
      ...
      {/* use document structure selector to change the style in a particular place */}
